...
<form action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data"
    class="flex md:flex flex-col space-y-2 max-w-[900px]" 
...
>
    ...
    <button type="button" @click="collapse = !collapse" class="hs-collapse-toggle 
        ...
        focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 
         dark:focus:ring-indigo-600 shadow-sm max-w-[830px]" 
        >
      ...
      >
        <div class="mt-5">
            <div class="flex md:flex-row flex-col gap-x-6">
                <div>
                    <div>
                    ...
                    <button type="submit" class="bg-slate-800 hover:bg-slate-700 w-full mt-4 text-white font-bold py-2 px-4 rounded-md">
                        Register
                      </button>
                </div>
                <div class="flex-col space-y-4">
                    <div >
                        ...
                        <x-input-select :options="$categories" name="categories" class="pt-2 pb-2 pl-4 mb-4" />
                    </div>
    
                    <div class="">
                        {{-- <x-input-files name="media" /> --}}
                        <x-input-label for="media" :value="'Upload image'" class="pb-2" />
                        <x-text-input id="media" type="file" name="media"/>
                    </div>
                </div>
